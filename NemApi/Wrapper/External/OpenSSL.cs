...
namespace CSharp2nem.External
{
  public class Protection
  {
    public static byte[] OpenSSLEncrypt(string plainText, byte[] passphrase)
    {
      // generate salt
      byte[] key, iv;
    ...
    public static string OpenSSLDecrypt(byte[] encrypted, byte[] passphrase)
    {
      // base 64 decode
