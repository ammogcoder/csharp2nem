...
namespace CSharp2nem.PrepareHttpRequests
{
    ...
    /// </remarks>
    public class ManualAsyncResult : IAsyncResult
    {
        ...
        internal RequestRetryHandler RequestRetryHandler { get; set; }
        internal AsyncRequestRetryHandler AsyncRequestRetryHandler { get; set; }
        /// <summary>
